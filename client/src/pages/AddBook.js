...
export default function AddBook() {
    ...
    let transaction = ()=>{history.push("/transaction")}
    let bookAdmin = ()=>{history.push("/book-admin")}
                    ...
                    <div className="row mt-5">
                        <form onSubmit={(e) => handleSubmit.mutate(e)}>
                            ...
                            <div className="row ms-5">
                                <div className="col-4  mt-3 ms-auto">
                                    <button type="submit" className ="bg-red text-light ms-5 me-0 px-3 py-2 rounded-3">Add Book &nbsp; <img src={bill} alt="bill" /></button>
                                </div>                          
                            </div>
                        </form>                           
                    </div>
